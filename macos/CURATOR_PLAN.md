...
- 177 tests executed, 10 opt-in skips, 0 failures. Single batched release build completed via `macos/build_app.sh`, code signature verified, and relaunched at PID 49623.
...
- 171 tests executed, 10 opt-in skips, 0 failures. Single batched release build completed and verified via `macos/build_app.sh` (`dist/Photo Curator.app`, strict deep code signature verified). Relaunched at PID 44819.
...
zero failures. Single batched release build completed and verified via macos/build_app.sh
...
passed (3 tests, 0.009s). Combined release build completed and verified via macos/build_app.sh
